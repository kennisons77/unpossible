...
# Solid Queue tables — generated from solid_queue 1.4.0 queue_schema.rb template.
# Do not edit manually; regenerate via `bin/rails solid_queue:install:migrations`.
