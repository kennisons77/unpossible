...
0b. Read `specifications/` to understand the current state of the project specifications.
...
corrections. If the human confirms, update the relevant files under `specifications/` with
