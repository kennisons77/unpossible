...
- [2026-03-25] Phase 1 complete: Scaffold admin views. DocumentsController (index, show), ConcernsController (index, show, confirm), Bootstrap-styled views with tables/badges/cards, navigation links added to navbar. Request specs for both controllers. Tests pass: 70 examples, 0 failures.
