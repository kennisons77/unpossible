...
This is the baseline for tool effectiveness comparison. See `specs/practices/verification.md`
...
See `specs/practices/coding.md` for the rationale behind this decision.
