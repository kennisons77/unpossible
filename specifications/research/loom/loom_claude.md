...
**IMPORTANT:** Before implementing any feature, consult the specifications in `specifications/README.md`.
...
- **Spec index:** `specifications/README.md` lists all specifications organized by category (core, LLM, security, etc.).
