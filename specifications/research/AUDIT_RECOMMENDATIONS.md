...
> `practices/general/`, `practices/lang/ruby.md`, `IDEAS.md`, `specifications/project-dashboard.md`.
> Reference: `specifications/PITCH.md`, `specifications/research/RESEARCH.md`, `specifications/research/loom/LOOM_ANALYSIS.md`.
...
Superseded by `PROMPT_build.md`. References `specifications/plan.md` directly instead of
...
Loading every file in `specifications/` every iteration is the current approach. Once the knowledge base
...
**Specs README as lookup table.** Loom's `specifications/README.md` maps each spec to its implementing
code. Adopt this for unpossible: a `specifications/README.md` table mapping each spec file to the Rails
