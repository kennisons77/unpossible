...
2. **If valuable** — add `design_notebook` as a node type in `specifications/system/reference-graph/concept.md` and define the frontmatter convention.
3. **If worth formalizing** — create a `design` skill (`specifications/skills/workflows/design.md`) that produces notebooks alongside or instead of PRDs.
