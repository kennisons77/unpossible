...
| File                       | Contains                                        |
|----------------------------|-------------------------------------------------|
| `specifications/README.md`          | Spec → module → loop type                       |
| `AGENTS.md`                | Build/run/test commands + key codebase patterns  |
| `specifications/practices/LOOKUP.md` | Term → practices file + rule name               |
...
✗  "see specifications/system/reference-graph/concept.md"
```
