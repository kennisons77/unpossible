...
| Load-bearing decision | `specifications/decisions/NNNN-title.md` | Choosing pgvector over Qdrant |
...
Lightweight ADRs in `specifications/decisions/`. One file per decision, numbered sequentially.
