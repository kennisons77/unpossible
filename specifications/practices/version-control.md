...
update its row in the relevant lookup table (`specifications/README.md`, `AGENTS.md`, or
`specifications/practices/LOOKUP.md`). This keeps lookup tables current without a separate
maintenance pass.
